...
## Weekly Folders
* Every week, a folder will be updated to the repository with all documentation and work for that week's LeetCode problems.
    * Each problem will have its own folder, as a subfolder within the weekly folder. 
    * Each problem's folder will contain separate files for that problem's description (which includes its name, difficulty, and category), the solution (in Python), and what was learned from the problem.
